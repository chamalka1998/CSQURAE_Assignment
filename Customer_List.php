        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">A list of customers for Tech Haven is a record of people who have purchased products
                        or services from the shop. It helps with customer retention, targeted marketing, and customer
                        service.</p>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="Customer_Update_UI.php?customer_id=<?php echo $data_row['customer_id']; ?>"><button type="button" class="btn btn-success" data-toggle="button" aria-pressed="false" autocomplete="off">
                                                                Edit
                                                            </button></a>


                                                        <a href="Customer_Delete.php?customer_id=<?php echo $data_row['customer_id']; ?>"><button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-danger" aria-pressed="false" autocomplete="off">
                                                                Delete
                                                            </button></a>
